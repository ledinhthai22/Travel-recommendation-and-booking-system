            ...
            <div className="bg-white rounded-3xl w-full max-w-3xl p-6 shadow-2xl">
                ...
                <div className="flex flex-col md:flex-row gap-6 mb-6">
                    ...
                    <div className="w-full md:w-1/2 flex flex-col gap-2">
                        <label className="text-sm font-semibold text-slate-700">Hình ảnh (Tối đa 10MB) <span className="text-red-500">*</span></label>
                        <label className="border-2 border-dashed border-sky-300 bg-sky-50 rounded-2xl h-48 w-full flex flex-col items-center justify-center cursor-pointer overflow-hidden hover:bg-sky-100 transition-colors">
                            {previewImage ? (
                                ...
                                <>
                                    ...
                                    <span className="text-sm text-sky-700 font-medium">Nhấn để tải ảnh lên</span>
                                    <span className="text-xs text-sky-500 mt-1">JPG, PNG, WEBP (Max 10MB)</span>
                                </>
                            )}
