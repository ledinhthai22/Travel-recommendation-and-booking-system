                ...
                <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/70 overflow-hidden">
                        ...
                        {isVnpay ? (
                            ...
                            <>
                                ...
                                <div className="rounded-2xl bg-sky-50 border border-sky-100 px-5 py-4 flex gap-3">
                                    ...
                                    <p className="text-xs text-sky-700 leading-relaxed">
                                        Nếu cần hỗ trợ, vui lòng liên hệ hotline đã gửi đính kèm theo email
                                    </p>
                                </div>
                            </>
                        )}
                    ...
                    <div className="px-8 pb-10 flex flex-col gap-3">
                        ...
                        <button
                            ...
                            className="cursor-pointer flex items-center justify-center gap-2 rounded-2xl border border-slate-200 py-4 font-medium text-slate-600 hover:bg-slate-50 hover:border-slate-300 transition-all text-sm"
                        >
