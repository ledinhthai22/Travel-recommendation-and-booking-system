...
export default function RowActionsButton({
    ...
    return (
        <>
            ...
            >
                <span className="material-symbols-outlined text-base" style={{ fontSize: '16px' }}>settings</span>
            ...
            {isOpen && createPortal(
                ...
                >
                    ...
                    {showView && onView && (
                        ...
                        >
                            <Eye size={16} className="text-blue-600"/> xem
                        </button>
                    )}
                    ...
                    {showEdit && onEdit && (
                        <button
                            ...
                            text-left transition-colors text-xs font-medium"
                        >
                            <span className="material-symbols-outlined text-amber-600" style={{ fontSize: '16px' }}>
