...
export default function HeroSection({
    ...
    const handleStartDateChange = (dateStr) => {
        ...
        // Nếu ngày về nhỏ hơn ngày đi mới chọn thì reset ngày về
    ...
    return (
        <section className="relative h-[650px] min-h-[600px] flex items-center justify-center mt-16 overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-10xl px-4 text-center text-white -translate-y-7">
                ...
                {showSearchBar && (
                    ...
                    >
                        ...
                        {/* Ngày đi (Dùng DatePicker Custom) */}
                        ...
                        {/* Ngày về (Dùng DatePicker Custom) */}
                        <div className="group flex items-center gap-3 flex-1 hover:bg-gray-50 rounded-xl px-2 py-1 transition-all">
                            <div className="w-full text-left custom-search-datepicker">
                                <DatePicker
                                    label="Ngày về"
                                    ...
                                    minDate={startDate ? new Date(startDate) : new Date()} // Ngày về phải lớn hơn hoặc bằng ngày đi
                                    disabled={!startDate} // Chưa chọn ngày đi thì khóa ngày về
                                    Icon={Calendar}
                                />
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            onClick={(e) => {
                                ...
                                // Xử lý logic tìm kiếm điều hướng tại đây
                            }}
            ...
            {/* CSS bổ sung để ẩn Border thô của DatePicker khi nhét vào thanh SearchBar */}
            <style>{`
                .custom-search-datepicker border {
                    border: none !important;
                }
                .custom-search-datepicker .relative.flex {
                    gap: 0px !important;
                }
                ...
                .custom-search-datepicker span.absolute {
                    left: 0px !important;
                }
            `}</style>
        </section>
